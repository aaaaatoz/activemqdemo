...
public class JMSTopicMessageConsumerListener {
    ...
    public static void main(String[] args) {
        ...
        ConnectionFactory connectionFactory = new ActiveMQConnectionFactory(
                JMSTopicMessageConsumerListener.USERNAME,
                JMSTopicMessageConsumerListener.PASSWORD,
                JMSTopicMessageConsumerListener.BROKERURL);
