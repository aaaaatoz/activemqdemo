...
public class JMSQueueMessageProducer {
    ...
    public static void main(String[] args) {
        ...
        ConnectionFactory connectionFactory = new ActiveMQConnectionFactory(JMSQueueMessageProducer.USERNAME, JMSQueueMessageProducer.PASSWORD, JMSQueueMessageProducer.BROKERURL);
        ...
        try {
            ...
            // create the destination with queue
    ...
    public static void sendMessage(Session session, MessageProducer messageProducer) throws Exception {
        for (int i = 0; i < JMSQueueMessageProducer.MSGCount; i++) {
